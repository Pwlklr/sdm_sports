...
from src.sports.football.contest.roster import match_clock_limit, player_name_for_id
...
from src.sports.football.console.roster_view import format_squad_lines
